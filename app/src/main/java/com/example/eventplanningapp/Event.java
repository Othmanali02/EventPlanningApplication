...
public class Event {
    ...
    public Event(int eventID, String eventName, String eventImage, String eventDate, String eventDescription, String likeCount, String eventLocation, String eventPlanner, String eventPricing) {
